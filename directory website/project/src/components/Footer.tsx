        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-600 dark:text-slate-400">
              <li><Link to="/companies" className="hover:text-slate-900 dark:hover:text-white transition-colors">Companies</Link></li>
              <li><Link to="/talent" className="hover:text-slate-900 dark:hover:text-white transition-colors">Talent</Link></li>
              <li><Link to="/browse" className="hover:text-slate-900 dark:hover:text-white transition-colors">Browse All</Link></li>
              <li><Link to="/join" className="hover:text-slate-900 dark:hover:text-white transition-colors">Join Directory</Link></li>
            </ul>
          </div>
